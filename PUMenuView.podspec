...
Pod::Spec.new do |s|
  ...
  s.author             = { "Wang Jinghan" => "jinghan.w@icloud.com" }
  ...
  s.source       = { :git => "https://github.com/null09264/PUMenuView.git", :tag => "1.0.5", :commit => "c3d111c6b6c73f5edd3a1e6d21ee119534ae125b" }
